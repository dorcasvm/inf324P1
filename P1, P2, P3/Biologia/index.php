<html>
	...
	<body style="background: #7caccc">
		...
		<div class="menu" style="background: #ac0606">
			<ul>
				<li><a class="elegido" style="font-family: Arial Black; color: #ffffff" href="../index.php">PRINCIPAL</a></li>
				...
				<li><a style="font-family: Arial; background: #04548f;">BIOLOGIA</a></li>
			</ul>
		</div>
		<div class="cuerpo">
			<center><img style="width: 200; height: 250; " src="logoBIO.jpg"></center>
			<center><h1 class="titulo">B I E N V E N I D O</h1></center>
			<center><h3 class="titulo3">A LA PAGINA DE BIOLOGIA</h3>></center>
		</div>
	</body>
</html>